...
interface MutableTask extends Task {
    abstract void updateFieldValue(Long fieldId, value, User user, EventDispatchOption eventDispatchOption)
    ...
    abstract void removeAttachment(Long id, User user, EventDispatchOption eventDispatchOption)
    abstract void addComment(String body, User user, EventDispatchOption eventDispatchOption)
    abstract void removeComment(Long id, User user, EventDispatchOption eventDispatchOption)
